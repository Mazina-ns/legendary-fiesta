...
<p> Проект 7: Собеседование. Excel.
<p>Что нужно было сделать:<p>
<ol>
  <li>Вопрос №1. Знаете ли вы функцию ВПР? Каков ее синтаксис и для чего она используется? Расскажите о задачах, в которых вы ее использовали</li>
  <li>Вопрос №2. Что такое мера и измерение? Расскажите на примере сводной таблицы. Приведите пример сводной таблицы, когда поле «Возраст» является измерением и когда поле «Возраст» является мерой?</li>
  <li>Вопрос №3. Расскажите о калькуляторе юнит-экономики. Какой проект вы делали и какой у вас получился результат?</li>
  <li>Вопрос №4. Что такое маржинальность? Как ее определять и какие основные виды костов вы знаете?</li>
