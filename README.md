...
<p> Проект 4: Работа с нестандартными данными.
<p>Что нужно было сделать:<p>
<ol>
  <li>Задача №1. Посчитайте среднюю продолжительность уроков студента с id 365003359</li>
  <li>Задача №2.Посчитайте, какой процент людей имеет голубой цвет глаз</li>
<li>Задача №3.Посчитайте средний объем ВВП на душу населения по ППС (паритет покупательной способности) по странам за последний доступный год. Вам необходимо настроить подключение к странице Википедии</li>
